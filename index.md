...
| Path | 内容 / Description |
|---|---|
| `AITL_Strategy_Proposal_Draft_v3.md` | 提言書 本文（Markdown） / Full proposal (MD) |
| `Figures/AITL_Strategy_Proposal_Draft_v3.pdf` | 提言書 PDF / Proposal PDF |
...
| `03_industry_use/` | 産業実装・PoC事例 / Industry use cases & PoC |
| `04_ai_integration/` | LLM統合テンプレート / LLM integration templates |
...
Contact: ✉️ shin3t72@gmail.com ｜ X: https://x.com/shin3t72 ｜ 🌐 https://samizo-aitl.github.io/
